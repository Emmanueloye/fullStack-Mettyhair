...
const checkoutController = __importStar(require("./checkoutController"));
const authMiddleware = __importStar(require("../../middlewares/authMiddleware"));
const router = (0, express_1.Router)();
router
    .route('/')
    .post(authMiddleware.protect, checkoutController.validateCheckout, checkoutController.checkout);
