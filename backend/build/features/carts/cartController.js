...
exports.deleteCart = exports.updateCart = exports.getAllCarts = exports.addToCart = void 0;
...
const addToCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield cartService.AddProductToCart(req, res);
});
exports.addToCart = addToCart;
const getAllCarts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield cartService.getUserCarts(req, res);
});
exports.getAllCarts = getAllCarts;
exports.updateCart = factory.updateOne({
    Model: cartModel_1.default,
    label: 'cart',
    includedFields: ['quantity'],
});
exports.deleteCart = factory.deleteOne({ Model: cartModel_1.default, label: 'cart' });
