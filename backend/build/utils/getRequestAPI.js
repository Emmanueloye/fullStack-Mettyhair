...
exports.paginateDetails = void 0;
class GetRequestAPI {
    ...
    filter() {
        ...
        if (this.reqQuery.search && this.reqQuery.value) {
            newQueryStr[this.reqQuery.search] = {
                $regex: new RegExp(this.reqQuery.value),
                $options: 'i',
            };
        }
...
const paginateDetails = (documentCount, req) => {
...
exports.paginateDetails = paginateDetails;
exports.default = GetRequestAPI;
